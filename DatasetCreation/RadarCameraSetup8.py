...
from CaptureRadarCameraData import (
...
def main():
    ...
    try:
        from CaptureRadarCameraData import destroy_dataset_radars
    ...
    camera_output_path = "camera_points_dataset.txt"
    ...
    print(
        ...
        f"FOV={int(RADAR_HORIZONTAL_FOV_DEG)}°, "
        f"points_per_second={radar_pps}, sensor_tick=0.0",
    )

    radar_positions = {
        "R1": make_transform(-33.825321, -48.015091, 3.0, 0.0, 0.0, 0.0),
        "R2": make_transform(-33.825321, -76.745476, 3.0, 0.0, 180.0, 0.0),

        "R3": make_transform(3.355103, -48.015091, 3.0, 0.0, 0.0, 0.0),
        "R4": make_transform(3.355103, -76.745476, 3.0, 0.0, 180.0, 0.0),

        "R5": make_transform(40.535528, -48.015091, 3.0, 0.0, 0.0, 0.0),
        "R6": make_transform(40.535528, -76.745476, 3.0, 0.0, 180.0, 0.0),

        "R7": make_transform(77.715952, -48.015091, 3.0, 0.0, 0.0, 0.0),
        "R8": make_transform(77.715952, -76.745476, 3.0, 0.0, 180.0, 0.0),
    }

    # Upper-row ±40° cone flips match RadarCameraSetup12 / 14: east columns like R9/R11 (here R5/R7).
    flipped_40_deg_names = {"R5", "R4"}
