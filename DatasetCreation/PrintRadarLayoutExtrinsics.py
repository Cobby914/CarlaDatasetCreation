...
def layout_8(current_map) -> dict[str, carla.Transform]:
    radar_positions = {
        ...
        "R3": make_transform(3.355103, -52.015091, 1.0, 0.0, 0.0, 0.0),
        "R4": make_transform(3.355103, -74.745476, 1.0, 0.0, 180.0, 0.0),
        "R5": make_transform(40.535528, -52.015091, 1.0, 0.0, 0.0, 0.0),
        "R6": make_transform(40.535528, -74.745476, 1.0, 0.0, 180.0, 0.0),
        "R7": make_transform(77.715952, -52.015091, 1.0, 0.0, 0.0, 0.0),
        "R8": make_transform(77.715952, -74.745476, 1.0, 0.0, 180.0, 0.0),
    }
    radar_positions = apply_road_alignment(
        current_map, radar_positions, flipped_40_deg_names={"R5", "R7"}
    )
    tr1 = radar_positions["R1"]
    tr2 = radar_positions["R2"]
    r1_yaw = normalize_angle(tr2.rotation.yaw + 90)
